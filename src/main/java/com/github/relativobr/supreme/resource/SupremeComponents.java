...
public class SupremeComponents {
  ...
  public static final SlimefunItemStack SUPREME_NUGGET = new SupremeItemStack("SUPREME_SUPREME_NUGGET", "cffc977cc7e10e564a09638a53bbc4c54c9c8dac7450ba3dfa3c9099d94f5");
  public static final ItemStack[] RECIPE_SUPREME_NUGGET = {null, null, null, null, null, null, null, null, null};

  public static final SlimefunItemStack SUPREME = new SupremeItemStack("SUPREME_SUPREME", "c69e3e6e5b2b92f0beb368b738b993d7ba225bf9bb2758bfc9fc2daba4a5a7d");
  ...
  public static final SlimefunItemStack THORNIUM_BIT = new SupremeItemStack("SUPREME_THORNIUM_BIT", MaterialCompat.safe(XMaterial.IRON_NUGGET));
  public static final ItemStack[] RECIPE_THORNIUM_BIT = {null, null, null, null, null, null, null, null, null};

  public static final SlimefunItemStack THORNIUM_DUST = new SupremeItemStack("SUPREME_THORNIUM_DUST", MaterialCompat.safe(XMaterial.GUNPOWDER));
  ...
  public static final SlimefunItemStack THORNIUM_INGOT = new SupremeItemStack("SUPREME_THORNIUM_INGOT", MaterialCompat.safe(XMaterial.IRON_INGOT));
  ...
  public static final SlimefunItemStack THORNIUM_BIT_SYNTHETIC = new SupremeItemStack("SUPREME_THORNIUM_BIT_SYNTHETIC", MaterialCompat.safe(XMaterial.GOLD_NUGGET));
  ...
  public static final SlimefunItemStack THORNIUM_DUST_SYNTHETIC = new SupremeItemStack("SUPREME_THORNIUM_DUST_SYNTHETIC", MaterialCompat.safe(XMaterial.GLOWSTONE_DUST));
  ...
  public static final SlimefunItemStack THORNIUM_INGOT_SYNTHETIC = new SupremeItemStack("SUPREME_THORNIUM_INGOT_SYNTHETIC", MaterialCompat.safe(XMaterial.GOLD_INGOT));
  ...
  public static final SlimefunItemStack THORNIUM_CARBONADO = new SupremeItemStack("SUPREME_THORNIUM_CARBONADO", MaterialCompat.safe(XMaterial.NETHERITE_INGOT));
  ...
  public static final SlimefunItemStack THORNIUM_ENERGIZED = new SupremeItemStack("SUPREME_THORNIUM_ENERGIZED", MaterialCompat.safe(XMaterial.NETHERITE_INGOT));
  ...
  public static final SlimefunItemStack ALLOY_ZIRCONIUM = new SupremeItemStack("SUPREME_ALLOY_ZIRCONIUM", MaterialCompat.safe(XMaterial.IRON_INGOT));
  ...
  public static final SlimefunItemStack ZIRCONIUM_PLATE = new SupremeItemStack("SUPREME_ZIRCONIUM_PLATE", MaterialCompat.safe(XMaterial.IRON_BLOCK));
  ...
  public static final SlimefunItemStack ALLOY_TITANIUM = new SupremeItemStack("SUPREME_ALLOY_TITANIUM", MaterialCompat.safe(XMaterial.IRON_INGOT));
  ...
  public static final SlimefunItemStack TITANIUM_PLATE = new SupremeItemStack("SUPREME_TITANIUM_PLATE", MaterialCompat.safe(XMaterial.IRON_BLOCK));
  ...
  public static final SlimefunItemStack ALLOY_IRIDIUM = new SupremeItemStack("SUPREME_ALLOY_IRIDIUM", MaterialCompat.safe(XMaterial.IRON_INGOT));
  ...
  public static final SlimefunItemStack IRIDIUM_PLATE = new SupremeItemStack("SUPREME_IRIDIUM_PLATE", MaterialCompat.safe(XMaterial.IRON_BLOCK));
  ...
  public static final SlimefunItemStack ALLOY_AURUM = new SupremeItemStack("SUPREME_ALLOY_AURUM", MaterialCompat.safe(XMaterial.GOLD_INGOT));
  ...
  public static final SlimefunItemStack AURUM_PLATE = new SupremeItemStack("SUPREME_AURUM_PLATE", MaterialCompat.safe(XMaterial.GOLD_BLOCK));
  ...
  public static final SlimefunItemStack ALLOY_MANGANESE = new SupremeItemStack("SUPREME_ALLOY_MANGANESE", MaterialCompat.safe(XMaterial.GOLD_INGOT));
  ...
  public static final SlimefunItemStack MANGANESE_PLATE = new SupremeItemStack("SUPREME_MANGANESE_PLATE", MaterialCompat.safe(XMaterial.GOLD_BLOCK));
  ...
  public static final SlimefunItemStack ALLOY_PLATINUM = new SupremeItemStack("SUPREME_ALLOY_PLATINUM", MaterialCompat.safe(XMaterial.GOLD_INGOT));
  ...
  public static final SlimefunItemStack PLATINUM_PLATE = new SupremeItemStack("SUPREME_PLATINUM_PLATE", MaterialCompat.safe(XMaterial.GOLD_BLOCK));
  ...
  public static final SlimefunItemStack ALLOY_ADAMANTIUM = new SupremeItemStack("SUPREME_ALLOY_ADAMANTIUM", MaterialCompat.safe(XMaterial.NETHERITE_INGOT));
  ...
  public static final SlimefunItemStack ADAMANTIUM_PLATE = new SupremeItemStack("SUPREME_ADAMANTIUM_PLATE", MaterialCompat.safe(XMaterial.NETHERITE_BLOCK));
  ...
  public static final SlimefunItemStack SYNTHETIC_AMETHYST = new SupremeItemStack("SUPREME_SYNTHETIC_AMETHYST", MaterialCompat.safe(XMaterial.PURPLE_DYE));
  public static final ItemStack[] RECIPE_SYNTHETIC_AMETHYST = {SlimefunItems.SYNTHETIC_SAPPHIRE.item(),
      ...
      new ItemStack(MaterialCompat.safe(XMaterial.AMETHYST_SHARD)), SlimefunItems.MAGIC_LUMP_3.item(), SlimefunItems.SYNTHETIC_SAPPHIRE.item(),
      SlimefunItems.MAGIC_LUMP_3.item(), SlimefunItems.SYNTHETIC_SAPPHIRE.item()};

  public static final SlimefunItemStack SYNTHETIC_RUBY = new SupremeItemStack("SUPREME_SYNTHETIC_RUBY", MaterialCompat.safe(XMaterial.PINK_DYE));
  ...
  public static final SlimefunItemStack THORNERITE = new SupremeItemStack("SUPREME_THORNERITE", MaterialCompat.safe(XMaterial.NETHERITE_INGOT));
  ...
  public static final SlimefunItemStack INDUCTIVE_MACHINE = new SupremeItemStack("SUPREME_INDUCTIVE_MACHINE", MaterialCompat.safe(XMaterial.DEAD_FIRE_CORAL_BLOCK));
  ...
  public static final SlimefunItemStack INDUCTOR_MACHINE = new SupremeItemStack("SUPREME_INDUCTOR_MACHINE", MaterialCompat.safe(XMaterial.FIRE_CORAL_BLOCK));
  ...
  public static final SlimefunItemStack RUSTLESS_MACHINE = new SupremeItemStack("SUPREME_RUSTLESS_MACHINE", MaterialCompat.safe(XMaterial.DEAD_BRAIN_CORAL_BLOCK));
  ...
  public static final SlimefunItemStack STAINLESS_MACHINE = new SupremeItemStack("SUPREME_STAINLESS_MACHINE", MaterialCompat.safe(XMaterial.BRAIN_CORAL_BLOCK));
  ...
  public static final SlimefunItemStack CARRIAGE_MACHINE = new SupremeItemStack("SUPREME_CARRIAGE_MACHINE", MaterialCompat.safe(XMaterial.DEAD_HORN_CORAL_BLOCK));
  ...
  public static final SlimefunItemStack CONVEYANCE_MACHINE = new SupremeItemStack("SUPREME_CONVEYANCE_MACHINE", MaterialCompat.safe(XMaterial.HORN_CORAL_BLOCK));
  ...
  public static final SlimefunItemStack PETRIFIER_MACHINE = new SupremeItemStack("SUPREME_PETRIFIER_MACHINE", MaterialCompat.safe(XMaterial.DEAD_TUBE_CORAL_BLOCK));
  ...
  public static final SlimefunItemStack CRYSTALLIZER_MACHINE = new SupremeItemStack("SUPREME_CRYSTALLIZER_MACHINE", MaterialCompat.safe(XMaterial.TUBE_CORAL_BLOCK));
  ...
  public static final SlimefunItemStack BLEND_MACHINE = new SupremeItemStack("SUPREME_BLEND_MACHINE", MaterialCompat.safe(XMaterial.BUBBLE_CORAL_BLOCK));
  ...
  public static final SlimefunItemStack CENTER_CARD_SIMPLE = new SupremeItemStack("SUPREME_CENTER_CARD_SIMPLE", MaterialCompat.safe(XMaterial.MUSIC_DISC_11));
  ...
  public static final SlimefunItemStack CENTER_CARD_ADVANCED = new SupremeItemStack("SUPREME_CENTER_CARD_ADVANCED", MaterialCompat.safe(XMaterial.MUSIC_DISC_PIGSTEP));
  ...
  public static final SlimefunItemStack CENTER_CARD_ULTIMATE = new SupremeItemStack("SUPREME_CENTER_CARD_ULTIMATE", MaterialCompat.safe(XMaterial.MUSIC_DISC_MALL));
  ...
  public static final SlimefunItemStack DUST_NETHERITE = new SupremeItemStack("SUPREME_DUST_NETHERITE", MaterialCompat.safe(XMaterial.MELON_SEEDS));
  public static final ItemStack[] RECIPE_DUST_NETHERITE = new ItemStack[]{new ItemStack(MaterialCompat.safe(XMaterial.NETHERITE_INGOT)), null,
      null, null, null, null, null, null, null};

  public static final SlimefunItemStack DUST_GLOW_INK = new SupremeItemStack("SUPREME_DUST_GLOW_INK", MaterialCompat.safe(XMaterial.PUMPKIN_SEEDS));
  public static final ItemStack[] RECIPE_DUST_GLOW_INK = new ItemStack[]{new ItemStack(MaterialCompat.safe(XMaterial.GLOW_INK_SAC)), null,
      null, null, null, null, null, null, null};

  public static final SlimefunItemStack DUST_AMETHYST = new SupremeItemStack("SUPREME_DUST_AMETHYST", MaterialCompat.safe(XMaterial.BEETROOT_SEEDS));
  public static final ItemStack[] RECIPE_DUST_AMETHYST = new ItemStack[]{new ItemStack(MaterialCompat.safe(XMaterial.AMETHYST_SHARD)), null,
      null, null, null, null, null, null, null};

  public static final SlimefunItemStack EMPTY_MOBTECH = new SupremeItemStack("SUPREME_EMPTY_MOBTECH", MaterialCompat.safe(XMaterial.FIRE_CHARGE));
  ...
  public static final SlimefunItemStack GENE_BERSERK = new SupremeItemStack("SUPREME_GENE_BERSERK", MaterialCompat.safe(XMaterial.FIRE_CORAL));

  public static final SlimefunItemStack GENE_INTELLIGENCE = new SupremeItemStack("SUPREME_GENE_INTELLIGENCE", MaterialCompat.safe(XMaterial.TUBE_CORAL));

  public static final SlimefunItemStack GENE_LUCK = new SupremeItemStack("SUPREME_GENE_LUCK", MaterialCompat.safe(XMaterial.HORN_CORAL));
